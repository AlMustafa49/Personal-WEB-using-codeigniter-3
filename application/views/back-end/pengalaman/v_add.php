<div class="col-md-12">
            <div class="card card-warning">
              ...
              <?php
              echo form_open('pengalaman/add');
              ?>

              <div class="form-group">
                <label>Posisi</label>
                <input class="form-control" name="posisi" value="<?php set_value('posisi'); ?>" placeholder="Posisi">
              </div>

              <div class="form-group">
                <label>Instansi</label>
                <input class="form-control" name="instansi" value="<?php set_value('instansi'); ?>" placeholder="Instansi">
              </div>
